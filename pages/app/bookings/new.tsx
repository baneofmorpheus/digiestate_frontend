      ...
      <div className=' '>
        ...
        >
          <div className=''>
            ...
            ></SelectButton>
            <div className='x2l:w-2/3 ml-auto mr-auto'>
            ...
            <div className='text-center mb-4 '>
              <button
                ...
                className=' bg-gray-600 text-digiDefault flex ml-auto mr-auto items-center text-sm  mb-4 rounded-lg pl-8 pr-8 pt-2 pb-2'
                type='button'
                onClick={() => {
            ...
            <div>
              <button className='bg-gray-600 pt-2 pb-2 pl-4 pr-4 rounded-lg text-digiDefault'>
                Submit Booking
              </button>
            </div>
          </div>
